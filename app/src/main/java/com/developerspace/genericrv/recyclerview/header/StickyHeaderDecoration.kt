package com.developerspace.genericrv.recyclerview.header
...
class StickyHeaderDecoration(val mAdapter: StickyHeaderAdapter<*>, isVisible: Boolean = false) : RecyclerView.ItemDecoration() {
